...
let
  user      = "admin";
  password  = "password";
  hostname  = "6923c3aa7fa9f5cfa124a552";
  homeDir   = "/home/${user}";
...
in
{
  ...
  services.loki = {
    ...
    configuration = {
      ...
      storage_config = {
        boltdb_shipper = {
          active_index_directory = "/var/lib/grafana-loki/boltdb-shipper-active";
          cache_location = "/var/lib/grafana-loki/boltdb-shipper-cache";
        };
        filesystem.directory = "/var/lib/grafana-loki/chunks";
      };
      compactor = {
        working_directory = "/var/lib/grafana-loki/boltdb-shipper-compactor";
      };
      ruler = {
